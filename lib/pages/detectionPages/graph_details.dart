...
import 'package:seedscan2/pages/detectionPages/liveViabilityDetectionPage.dart'; // Import ModelReading

class ReadingDetailsPage extends StatelessWidget {
  final ModelReading reading;

  const ReadingDetailsPage({Key? key, required this.reading}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    List<BarChartGroupData> createBarData() {
      return reading.labelCounts.entries
          .map(
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Details for ${reading.timestamp}"),
