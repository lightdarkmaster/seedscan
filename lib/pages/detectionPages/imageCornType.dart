...
class ImageCornType extends StatefulWidget {
  const ImageCornType({Key? key}) : super(key: key);

  @override
  _ImageCornTypeWidgetState createState() =>
      _ImageCornTypeWidgetState();
}

class _ImageCornTypeWidgetState extends State<ImageCornType> {
